...
export default function Roleplay() {
  ...
  return (
    <>
      <Head>
        <title>AI Roleplay Trainer — FSA Elite Sales Training</title>
        <meta
          name="description"
          content="Practice objection handling inside the FSA Elite AI sales roleplay trainer."
        />
      </Head>
      ...
      <main style={{ minHeight: '100vh', background: 'var(--color-bg)', display: 'flex', flexDirection: 'column' }}>
        ...
        >
          <p style={{ color: 'var(--color-muted)', fontSize: '0.8rem', textAlign: 'center' }}>
            Practice objection handling with the FSA Elite AI customer simulator. Type{' '}
