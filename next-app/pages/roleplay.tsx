...
export default function Roleplay() {
  ...
  return (
    <>
      <Head>
        <title>AI Sales Roleplay Trainer — FSA Elite</title>
        <meta
          name="description"
          content="Practice objection handling with an AI car-buying customer. Sharpen your close with FSA Elite's interactive sales roleplay trainer."
        />
      </Head>
      ...
      <main style={{ minHeight: '100vh', background: 'var(--color-bg)', display: 'flex', flexDirection: 'column' }}>
        ...
        >
          <p style={{ color: 'var(--color-muted)', fontSize: '0.8rem', textAlign: 'center' }}>
            Practice handling real buyer objections. Select a scenario or start typing. Type{' '}
            <code style={{ color: 'var(--color-primary)' }}>/help</code> at any time for coaching feedback.
          </p>
