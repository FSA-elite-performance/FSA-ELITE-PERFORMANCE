...
export default function Roleplay() {
  ...
  const hasUserResponses = messages.some((message) => message.role === 'user');
  ...
  return (
    <>
      <Head>
        <title>AI Roleplay — FSA Elite Sales Training</title>
        <meta
          name="description"
          content="Practice your sales skills with an AI customer. Handle real objections, build rapport, and close more deals."
        />
      </Head>
      ...
      <main style={{ minHeight: '100vh', background: 'var(--color-bg)', display: 'flex', flexDirection: 'column' }}>
        ...
        >
          ...
          <button
            ...
            disabled={loading || !hasUserResponses}
            style={{
              background: 'transparent',
              border: '1px solid var(--color-border)',
              color: loading || !hasUserResponses ? '#6e6e6e' : 'var(--color-primary)',
              borderRadius: 'var(--radius)',
              padding: '0.35rem 0.85rem',
              fontSize: '0.8rem',
              cursor: loading || !hasUserResponses ? 'not-allowed' : 'pointer',
            }}
          >
            Inspect Session
          </button>
        ...
        >
          <p style={{ color: 'var(--color-muted)', fontSize: '0.8rem', textAlign: 'center' }}>
            Practice selling to a tough AI customer. Type <code style={{ color: 'var(--color-primary)' }}>/help</code> for coaching
            feedback or <code style={{ color: 'var(--color-primary)' }}>/inspect</code> for a full session inspection.
          </p>
