...
export default function Roleplay() {
  ...
  return (
    <>
      <Head>
        <title>AI Sales Trainer — FSA Elite</title>
        <meta
          name="description"
          content="Practice live objection handling with the FSA Elite AI Sales Trainer. Powered by GPT-4o — available 24/7 for automotive sales professionals."
        />
      </Head>
      ...
      <main style={{ minHeight: '100vh', background: 'var(--color-bg)', display: 'flex', flexDirection: 'column' }}>
        ...
        >
          <p style={{ color: 'var(--color-muted)', fontSize: '0.8rem', textAlign: 'center' }}>
            Practice live objection handling with an AI customer. Pick a scenario below or start typing.
            Type <code style={{ color: 'var(--color-primary)' }}>/help</code> for coaching feedback.
          </p>
