        ...
        >
          <div className="container">
            ...
            >
              ...
              >
                Study Like a <span style={{ color: '#f5a623' }}>Closer</span>
              </h2>
              <p style={{ color: '#aaa', marginBottom: '1.75rem', fontSize: '0.98rem', lineHeight: 1.7 }}>
                29 interactive flashcards covering objection handling, pipeline rules, closing techniques,
                mindset, and the FSA Elite Sales OS. Tap to flip. Track what you know. Shuffle and repeat.
              </p>
              <Link href="/study" className="btn-primary" style={{ display: 'inline-block' }}>
                📖 Start Studying Now →
              </Link>
            </div>
          </div>
