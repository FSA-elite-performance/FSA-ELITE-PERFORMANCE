...
const PLATFORM_OVERVIEW = [
  {
    status: 'Live now',
    title: 'Early Access Store',
    body: 'Review the offer, lock in the founding member rate, and start checkout from the deployed app.',
    href: '#pricing',
    cta: 'See pricing',
  },
  {
    ...
    body: 'Jump straight into objection-handling practice with the AI customer trainer that is already built.',
    href: '/roleplay',
    cta: 'Open trainer',
  },
  {
    ...
    body: 'Closer mindset lessons, process walkthroughs, and callout-based teaching are being packaged into the portal.',
  },
  {
    status: 'In progress',
    title: 'Certifications & Badges',
    body: 'Verified skill tracking is planned so members can prove progress as they complete the curriculum.',
  },
  {
    status: 'In progress',
    title: 'Sales Calculators',
    body: 'Deal, payment, and performance tools are queued up so the platform becomes useful on the floor every day.',
  },
];
      ...
      <main style={{ fontFamily: 'var(--font-sans)' }}>
        ...
        >
          <div className="container">
            ...
            >
              The deployed app now puts the current experience and near-term roadmap in one place so
              you can review what is live today and what is shipping next.
            </p>
                ...
                >
                  <span
                    style={{
                      ...
                      background: item.status === 'Live now' ? '#1f2d14' : '#1e1a12',
                      color: item.status === 'Live now' ? '#8fd16a' : '#f5a623',
                      border: '1px solid #2a2a2a',
                      borderRadius: '999px',
                  ...
                  <p style={{ color: '#aaa', fontSize: '0.92rem', lineHeight: 1.65, flex: 1 }}>{item.body}</p>
                  {item.href && (
                    <Link
                      href={item.href}
                      style={{
