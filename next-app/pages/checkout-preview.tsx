          ...
          <div className="container checkout-preview-shell">
            ...
            <aside className="checkout-preview-card">
              <div className="home-dual-logos" style={{ marginBottom: '0.8rem' }}>
                <img className="home-brand-logo" src="/logo.png" alt="FSA ELITE Performance logo" style={{ width: '2.8rem' }} />
              ...
              <p className="checkout-preview-note">
                Membership access unlocks the training area and the FSA clothing store after payment is confirmed.
              </p>
              <p className="checkout-preview-note">
