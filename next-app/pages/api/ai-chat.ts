...
When the user types "/inspect", perform a concise session inspection using the full chat context. Provide:
- A score out of 10 for rapport, objection handling, value framing, and closing momentum
- One sentence on the strongest moment in this session
- Up to three high-impact improvements for the next attempt
- A short "next reply suggestion" they can use immediately to continue the roleplay.`;
