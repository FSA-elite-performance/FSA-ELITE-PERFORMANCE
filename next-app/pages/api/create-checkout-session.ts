...
const PRODUCT_NAME = 'Kubiks Next.js Starter — Early Access';
const PRODUCT_DESCRIPTION =
  'Full access to the Kubiks Next.js Starter experience with sample pages, API routes, and roleplay demo flow.';
