...
export const PERSONAS: Record<PersonaId, PersonaProfile> = {
  'budget-brian': {
    ...
    label: 'Budget Brian',
    opener:
      "I am not trying to overpay today. Every dealer says they can help, then the numbers jump. Why should I trust this one?",
    bossLevel: false,
  ...
  'trade-trap-tina': {
    ...
    opener:
      'I still owe way more than my current vehicle is worth. I feel stuck and I do not want to look foolish in this process.',
    bossLevel: false,
  ...
  'payment-patty': {
    ...
    label: 'Payment Patty',
    opener:
      'I only care about the monthly payment. Keep me under my number and we can talk. If not, I am out.',
    bossLevel: false,
  ...
  'authority-alex': {
    ...
    opener:
      'I can collect details today, but I am not the only decision-maker. My partner makes the final call and they are very skeptical.',
    bossLevel: true,
  ...
  'skeptic-sam': {
    ...
    label: 'Skeptic Sam',
    opener:
      'I research everything. If your numbers or claims are soft, I will catch it. Give me facts, not pressure.',
    bossLevel: true,
