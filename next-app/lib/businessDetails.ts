...
export const SUPPORT_PHONE = '+1 (337) 336-2635';

export const SUPPORT_ADDRESS_LINE_1 = '213 Caribbean Boulevard';
export const SUPPORT_ADDRESS_CITY = 'Sunset';
export const SUPPORT_ADDRESS_STATE = 'LA';
export const SUPPORT_ADDRESS_POSTAL = '70584';
export const SUPPORT_ADDRESS_COUNTRY = 'US';

export const STRIPE_STATEMENT_DESCRIPTOR = 'FSA ELITE PERFORMANCE';