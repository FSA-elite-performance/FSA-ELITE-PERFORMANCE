...
const STORE_DOMAIN_HOSTS = new Set([
  ...
  'www.store.fsaeliteperformance.com',
]);
...
const WWW_REDIRECTS: Record<string, string> = {
  ...
  'www.store.fsaeliteperformance.com': 'https://store.fsaeliteperformance.com',
};
...
export async function middleware(request: NextRequest) {
  ...
  // 0b. Store-domain redirect — store.fsaeliteperformance.com / fsaeliteperformance.store → /store
