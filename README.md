...
Type `/inspect` (or use the **Inspect Session** button) to get a full-session inspection with scores, strengths, improvement priorities, and a suggested next reply.
