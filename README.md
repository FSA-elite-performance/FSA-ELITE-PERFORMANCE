...
## 🌐 Domain Setup — IONOS + Store Domain

FSA Elite uses **one active production domain**:

| Domain | Purpose | Platform |
|---|---|---|
| **fsaeliteperformance.com** | Store — Stripe checkout & payments | Vercel |

> **Legacy note:** `fsaelite.org` is no longer an active production domain and should redirect to `https://fsaeliteperformance.com`.

### Step 1 — Point the Store Domain to Vercel in IONOS
...
- `https://fsaelite.org` → redirects to `https://fsaeliteperformance.com`
- `https://www.fsaelite.org` → redirects to `https://fsaeliteperformance.com`
...
- **Web:** [fsaeliteperformance.com](https://fsaeliteperformance.com)
