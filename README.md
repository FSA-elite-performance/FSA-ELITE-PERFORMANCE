...
| `NEXT_PUBLIC_BASE_URL` | Full URL of your deployment (e.g. `https://fsaeliteperformance.org` or `http://localhost:3000`) |
...
- `NEXT_PUBLIC_BASE_URL` → your production domain (e.g. `https://fsaeliteperformance.org`)
...
- **Email:** support@fsaeliteperformance.org  
- **Web:** [fsaeliteperformance.org](https://fsaeliteperformance.org)
