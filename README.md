...
If you import the repository into a platform that builds from the repository root, use the root-level `package.json` scripts or set the platform root directory to `next-app/` so the Next.js dependency is detected correctly.
