...
│   └── workflows/
│       ├── codeql.yml                  # Code vulnerability scanning (CodeQL)
│       ├── dependency-review.yml       # Supply-chain checks for dependency changes
│       ├── pages-deploy.yml            # GitHub Actions → GitHub Pages (static export)
│       └── secret-scan.yml             # Secret scanning in commits and PRs
...
- GitHub Actions now run automated secret scans, dependency reviews, and CodeQL analysis
