...
export const SUBSCRIPTION_DESCRIPTION =
  'One payment. Full access. AI objection drills, a 17+ product member store, and rep-branding tools that make closers sharper and more memorable — for less than a sales lunch.';
