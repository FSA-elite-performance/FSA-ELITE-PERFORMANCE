...
const FEATURES = [
  {
    title: 'Training Path',
    description: '19 short, practical lessons across 6 core topics — sales psychology, body language, objections, communication, closing, and mindset.',
    stat: '19',
    statLabel: 'Lessons',
  },
  {
    title: 'AI Practice Arena',
    description: '5 buyer personas with real-time scoring. The AI acts like a real customer and throws objections in real time.',
    stat: '5',
  ...
  {
    title: 'Member Store',
    description: 'Premium business cards, branded gear, and self-promo tools that make your presence memorable.',
    stat: '17+',
    statLabel: 'Products',
  },
];
...
const STEPS = [
  {
    num: '01',
    title: 'Join',
    description: 'One-time payment. Instant access to the full training platform.',
  },
  {
    num: '02',
    title: 'Learn',
    description: 'Follow the structured training path — 15 minutes a day across 6 core topics.',
  },
  {
    num: '03',
    title: 'Practice',
    description: 'Hit the AI Practice Arena. The bot throws real objections like a live customer.',
  },
  {
    num: '04',
    title: 'Close',
    description: 'Walk in sharper. Handle pressure. Make more money.',
  },
];
