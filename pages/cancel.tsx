...
export default function Cancel() {
  return (
    <>
      <Head>
        <title>Checkout Canceled | FSA ELITE Founding Access</title>
      </Head>
      <main className="status-page">
        ...
        <p>
          ...
          FSA ELITE Phase One access.
        </p>
        <p className="status-muted">Training and store access unlock after the one-time payment is completed.</p>
