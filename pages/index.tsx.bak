...
const ROADMAP_ITEMS = [
  {
    ...
    body: 'Native iPhone experience with roleplay sessions, saved progress, and member commerce built into the same ecosystem.',
  },
  {
    title: 'Android App Launch',
    body: 'Android release with synchronized profiles, challenge ladders, and mobile-first training access on the floor.',
  },
  {
...
const APP_INSPIRED_ITEMS = [
  {
    ...
    body: 'Borrow the best lesson from strong mobile training apps: short daily reps, clear prompts, and a reason to come back tomorrow instead of disappearing after one session.',
  },
  {
    title: 'Session Review Feedback',
    body: 'Like top coaching products, FSA tracks how a rep is performing in the moment so improvement feels measurable, not vague.',
  },
  {
      ...
      <main className="home-page">
            ...
            <div className="home-hero-grid">
              ...
              <aside className="home-command-panel" aria-label="FSA positioning panel">
                ...
                <div className="home-command-status" role="status" aria-label="Platform availability">
                  ...
                  <span>iOS in progress</span>
                  <span>Android in progress</span>
                </div>
              </aside>
            </div>
          </div>
        ...
        <section className="home-section home-section-alt">
          <div className="container">
            ...
            <h2 className="section-title">Web now. Mobile next. Higher-status member experience over time.</h2>
